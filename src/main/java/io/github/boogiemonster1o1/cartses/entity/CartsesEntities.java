...
import io.github.boogiemonster1o1.cartses.item.ShulkerBoxMinecartItem;
...
public class CartsesEntities {
	...
	public static final CartsesEntityType<ShulkerBoxMinecart> SHULKER_BOX_MINECART = CartsesEntityType.Builder.create(SpawnGroup.MISC, ShulkerBoxMinecart::new, ShulkerBoxMinecart::new).dimensions(EntityDimensions.fixed(0.98f, 0.7f)).trackRangeChunks(8).id(id("shuler_box_minecart")).customItemFactory(((type, settings) -> new ShulkerBoxMinecartItem(type, settings))).build();
